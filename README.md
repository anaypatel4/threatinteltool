...
This repository contains the research and development work by **Anay Patel** and **Jason Chinnam** for the project titled _"Threat Intelligence-Driven Cybersecurity Risk Management Tool"_, developed as part of **CY-670-A Research Project Seminar** under **Professor Nelson Gonzalez**.
